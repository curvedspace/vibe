 ...
 */
class VIBE_EXPORT VDeviceInterface : public QObject
{
    Q_OBJECT
    Q_ENUMS(Type)
    Q_DECLARE_PRIVATE(VDeviceInterface)
public:
    /**
    ...
    /**
     * Destroys a VDeviceInterface object.
     */
    virtual ~VDeviceInterface();
...
protected:
    /**
     * @internal
     * Creates a new VDeviceInterface object.
     *
     * @param dd the private d member. It will take care of deleting it upon destruction.
     * @param backendObject the device interface object provided by the backend
     */
    VDeviceInterface(VDeviceInterfacePrivate &dd, QObject *backendObject);

    VDeviceInterfacePrivate *d_ptr;

private:
    friend class VDevice;
    friend class VDevicePrivate;
};
