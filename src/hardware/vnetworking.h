...
#ifndef VNETWORKING_H
#define VNETWORKING_H
...
namespace VHardware
{
    ...
    namespace Networking
    {
         ...
         * it cannot report useful networking status @ref VNetworking::Status.
         */
        Status status();
        ...
        Q_SIGNALS:
             ...
             */
            void statusChanged(VHardware::Networking::Status status);
