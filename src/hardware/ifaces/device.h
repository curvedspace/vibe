...
#ifndef VHARDWARE_IFACES_DEVICE_H
#define VHARDWARE_IFACES_DEVICE_H
...
namespace VHardware
{
    namespace Ifaces
    {
         ...
         */
        class VIBE_EXPORT Device : public QObject
        {
            Q_OBJECT
        public:
            /**
             ...
             */
            virtual bool queryDeviceInterface(const VDeviceInterface::Type &type) const = 0;
             ...
             */
            virtual QObject *createDeviceInterface(const VDeviceInterface::Type &type) = 0;
...
#endif // VHARDWARE_IFACES_DEVICE_H
