...
#ifndef VHARDWARE_IFACE_DVBINTERFACE_H
#define VHARDWARE_IFACE_DVBINTERFACE_H
...
namespace VHardware
{
    namespace Ifaces
    {
         ...
         * file in the system.
         */
        class VIBE_EXPORT DvbInterface : virtual public DeviceInterface
        {
        public:
            /**
             ...
             */
            virtual VDvbInterface::DeviceType deviceType() const = 0;
             ...
             * @see VHardware::Ifaces::DvbInterface::deviceType
             */
