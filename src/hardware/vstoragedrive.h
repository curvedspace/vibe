...
#ifndef VSTORAGEDRIVE_H
#define VSTORAGEDRIVE_H

#include <VibeHardware/VDeviceInterface>

class VStorageDrivePrivate;
class Device;
 ...
 */
class VIBE_EXPORT VStorageDrive : public VDeviceInterface
{
    Q_OBJECT
    ...
    Q_DECLARE_PRIVATE(VStorageDrive)
...
private:
    /**
     * Creates a new VStorageDrive object.
     ...
     * @see VDevice::as()
     */
    explicit VStorageDrive(QObject *backendObject);

public:
    /**
     * Destroys a VStorageDrive object.
     */
    virtual ~VStorageDrive();

    /**
     * Get the VDeviceInterface::Type of the StorageDrive device interface.
     *
...
protected:
     ...
     * @internal
     */
    VStorageDrive(VStorageDrivePrivate &dd, QObject *backendObject);
};

#endif // VSTORAGEDRIVE_H
