...
#ifndef VAUDIOINTERFACE_H
#define VAUDIOINTERFACE_H
...
class VAudioInterfacePrivate;
class VDevice;

/**
 * This device interface is available on interfaces exposed by sound cards.
 */
class VIBE_EXPORT VAudioInterface : public VDeviceInterface
{
    Q_OBJECT
    ...
    Q_DECLARE_PRIVATE(VAudioInterface)
...
private:
    /**
     * Creates a new VAudioInterface object.
     ...
     * @see VDevice::as()
     */
    explicit VAudioInterface(QObject *backendObject);

public:
    /**
     * Destroys an VAudioInterface object.
     */
    virtual ~VAudioInterface();

    /**
     * Get the VDeviceInterface::Type of the AudioInterface device interface.
     *
     ...
     * @see VAudioInterface::AudioDriver
     */
     ...
     * @see VAudioInterface::AudioInterfaceType
     */
     ...
     * @see VAudioInterface::SoundcardType
     */
    SoundcardType soundcardType() const;
};

Q_DECLARE_OPERATORS_FOR_FLAGS(VAudioInterface::AudioInterfaceTypes)

#endif // VAUDIOINTERFACE_H
