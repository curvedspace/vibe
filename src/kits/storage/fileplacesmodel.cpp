...
namespace Qube
{
    namespace Storage
    {
        class FilePlacesModel::Private
        {
        public:
            Private(FilePlacesModel *self) : q(self), bookmarkManager(0), sharedBookmarks(0) {}
            ~Private() {
        ...
        void FilePlacesModel::Private::reloadAndSignal()
        {
            bookmarkManager->emitChanged(bookmarkManager->root()); // ... we'll get relisted anyway
        }

        QList<FilePlacesItem *> FilePlacesModel::Private::loadBookmarkList()
        {
            QList<FilePlacesItem*> items;
        ...
        void FilePlacesModel::Private::_q_initDeviceList()
        {
        ...
        void FilePlacesModel::Private::_q_deviceAdded(const QString &udi)
        {
        ...
        void FilePlacesModel::Private::_q_deviceRemoved(const QString &udi)
        {
        ...
        void FilePlacesModel::Private::_q_itemChanged(const QString &id)
        {
        ...
        void FilePlacesModel::Private::_q_reloadBookmarks()
        {
        ...
        void FilePlacesModel::Private::_q_storageSetupDone(Qube::Hardware::ErrorType error, QVariant errorData)
        {
        ...
        void FilePlacesModel::Private::_q_storageTeardownDone(Qube::Hardware::ErrorType error, QVariant errorData)
        {
