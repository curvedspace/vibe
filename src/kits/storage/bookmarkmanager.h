...
namespace QubeStorage
{
     ...
     * \endcode
     */
    class QUBESHARED_EXPORT BookmarkManager : public QObject
    {
        Q_OBJECT
    public:
        /**
         ...
         * @param update if true then BookmarkManager will listen to DBUS update requests.
         */
         ...
         * @see Bookmark::address
         */
        Bookmark findByAddress(const QString &address);
         ...
         */
        void emitChanged(const BookmarkGroup &group);
         ...
         * BookmarkManager, responsible for the given @p bookmarksFile.
         ...
         * The final DBus object path is /BookmarkManager/dbusObjectName
         * An empty dbusObjectName disables the registration to dbus (used for temporary managers)
         *
         */
        static BookmarkManager* managerForFile(const QString& bookmarksFile,
                                               const QString& dbusObjectName);

        /**
         * Returns a BookmarkManager, which will use KDirWatch for change detection
         * This is important when sharing bookmarks with other Desktops.
         * @param bookmarksFile full path to the bookmarks file
         * @since 4.1
         */
        static BookmarkManager* managerForExternalFile(const QString& bookmarksFile);

        /**
         * only used for BookmarkBar
         */
        static BookmarkManager* createTempManager();

        /**
         * Returns a pointer to the user's main (konqueror) bookmark collection.
         */
        static BookmarkManager* userBookmarksManager();
    ...
    private:
         ...
         * own path <em>before</em> BookmarkManager::managerForFile() is ever
         * called.
         *
         * @param bookmarksFile full path to the bookmarks file,
         ...
         * An empty dbusObjectName disables the registration to dbus (used for temporary managers)
         */
        BookmarkManager(const QString & bookmarksFile, const QString& dbusObjectName);
         ...
         * @since 4.1
         */
        BookmarkManager(const QString & bookmarksFile);
        ...
        */
        static BookmarkManager* managerForFile(const QString&, int);
    ...
    /**
     * The BookmarkMenu and BookmarkBar classes gives the user
    ...
    private:
        class BookmarkOwnerPrivate;
        BookmarkOwnerPrivate *d;
    };
}
