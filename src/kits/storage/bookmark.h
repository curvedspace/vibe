...
namespace QubeStorage
{
    ...
    class QUBESHARED_EXPORT Bookmark
    {
    ...
    public:
         ...
         * @see QList
         */
        class QUBESHARED_EXPORT List : public QList<Bookmark>
        {
        public:
            List();
...
#ifdef MAKE_KIO_LIB
    KDE_DUMMY_QHASH_FUNCTION(Bookmark)
#endif

    /**
     * A group of bookmarks
     */
    class QUBESHARED_EXPORT BookmarkGroup : public Bookmark
    {
    public:
        /**
    ...
    class QUBESHARED_EXPORT BookmarkGroupTraverser
    {
    protected:
...
Q_DECLARE_METATYPE(QubeStorage::Bookmark)
