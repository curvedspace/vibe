...
#ifndef VSTORAGEVOLUME_H
#define VSTORAGEVOLUME_H

#include <VibeHardware/VDeviceInterface>

class VStorageVolumePrivate;
class VDevice;
 ...
 */
class VIBE_EXPORT VStorageVolume : public VDeviceInterface
{
    Q_OBJECT
    Q_ENUMS(UsageType)
    ...
    Q_DECLARE_PRIVATE(VStorageVolume)
...
private:
    /**
     * Creates a new VStorageVolume object.
     ...
     * @see VDevice::as()
     */
    explicit VStorageVolume(QObject *backendObject);

public:
    /**
     * Destroys a VStorageVolume object.
     */
    virtual ~VStorageVolume();

    /**
     * Get the VDeviceInterface::Type of the StorageVolume device interface.
     *
     ...
     */
    VDevice encryptedContainer() const;

protected:
    /**
     * @internal
     */
    VStorageVolume(VStorageVolumePrivate &dd, QObject *backendObject);
};

#endif // VSTORAGEVOLUME_H
