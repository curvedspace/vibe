...
#ifndef VHARDWARE_IFACE_OPTICALDRIVE_H
#define VHARDWARE_IFACE_OPTICALDRIVE_H
...
namespace VHardware
{
    namespace Ifaces
    {
         ...
         */
        class VIBE_EXPORT OpticalDrive : virtual public StorageDrive
        {
        public:
            /**
             ...
             */
            virtual VOpticalDrive::MediumTypes supportedMedia() const = 0;
        ...
        protected:
            ...
            virtual void ejectDone(VHardware::ErrorType error, QVariant errorData, const QString &udi) = 0;
        };
    }
}
