...
namespace QubeHardware
{
    namespace Ifaces
    {
        ...
        public:
             ...
             */
            virtual QubeHardware::NetworkShare::ShareType type() const = 0;
...
Q_DECLARE_INTERFACE(QubeHardware::Ifaces::NetworkShare, "org.vision.Hardware.Ifaces.NetworkShare/0.1")
