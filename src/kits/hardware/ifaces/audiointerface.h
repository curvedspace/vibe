...
namespace QubeHardware
{
    namespace Ifaces
    {
        ...
        public:
             ...
             * @see QubeHardware::AudioInterface::AudioDriver
             */
            virtual QubeHardware::AudioInterface::AudioDriver driver() const = 0;
             ...
             * @see QubeHardware::AudioInterface::AudioInterfaceTypes
             */
            virtual QubeHardware::AudioInterface::AudioInterfaceTypes deviceType() const = 0;

            /**
             * Retrieves the type of soundcard (internal/headset/...).
             *
             * @return the type of soundcard
             * @see QubeHardware::AudioInterface::SoundcardType
             */
            virtual QubeHardware::AudioInterface::SoundcardType soundcardType() const = 0;
        };
    }
}

Q_DECLARE_INTERFACE(QubeHardware::Ifaces::AudioInterface, "org.vision.Hardware.Ifaces.AudioInterface/0.1.1")
