...
#ifndef VHARDWARE_IFACES_AUDIOINTERFACE_H
#define VHARDWARE_IFACES_AUDIOINTERFACE_H
...
namespace VHardware
{
    namespace Ifaces
    {
         ...
         */
        class VIBE_EXPORT AudioInterface : virtual public DeviceInterface
        {
        public:
            /**
             ...
             */
            virtual VAudioInterface::AudioDriver driver() const = 0;
             ...
             * @see VAudioInterface::AudioInterfaceTypes
             */
            virtual VAudioInterface::AudioInterfaceTypes deviceType() const = 0;
             ...
             */
            virtual VAudioInterface::SoundcardType soundcardType() const = 0;
        };
    }
}
