...
namespace QubeHardware
{
    namespace Ifaces
    {
        ...
        public:
             ...
             * @since 4.3
             */
            virtual QubeHardware::SerialInterface::SerialType serialType() const = 0;
...
Q_DECLARE_INTERFACE(QubeHardware::Ifaces::SerialInterface, "org.vision.Hardware.Ifaces.SerialInterface/0.1")
