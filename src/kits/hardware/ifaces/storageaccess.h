...
namespace QubeHardware
{
    namespace Ifaces
    {
        ...
        protected:
             ...
             * @param udi the UDI of the volume
             */
            virtual void setupDone(QubeHardware::ErrorType error, QVariant resultData, const QString &udi) = 0;
             ...
             * @param udi the UDI of the volume
             */
            virtual void teardownDone(QubeHardware::ErrorType error, QVariant resultData, const QString &udi) = 0;
...
Q_DECLARE_INTERFACE(QubeHardware::Ifaces::StorageAccess, "org.vision.Hardware.Ifaces.StorageAccess/0.1")
