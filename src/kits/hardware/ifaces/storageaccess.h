...
#ifndef QUBE_HARDWARE_IFACES_STORAGEACCESS_H
#define QUBE_HARDWARE_IFACES_STORAGEACCESS_H
    ...
    namespace Hardware
    {
        namespace Ifaces
        {
            ...
            protected:
                 ...
                 * @param udi the UDI of the volume
                 */
                virtual void setupDone(Qube::Hardware::ErrorType error, QVariant resultData, const QString &udi) = 0;
                 ...
                 * @param udi the UDI of the volume
                 */
                virtual void teardownDone(Qube::Hardware::ErrorType error, QVariant resultData, const QString &udi) = 0;
...
Q_DECLARE_INTERFACE(Qube::Hardware::Ifaces::StorageAccess, "org.vision.Qube.Hardware.Ifaces.StorageAccess/0.1")
