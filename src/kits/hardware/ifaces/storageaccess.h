...
#ifndef VHARDWARE_IFACES_STORAGEACCESS_H
#define VHARDWARE_IFACES_STORAGEACCESS_H
...
namespace VHardware
{
    namespace Ifaces
    {
         ...
         */
        class VIBE_EXPORT StorageAccess : virtual public DeviceInterface
        {
        public:
            /**
        ...
        protected:
             ...
             * @param udi the UDI of the volume
             */
            virtual void setupDone(VHardware::ErrorType error, QVariant resultData, const QString &udi) = 0;
             ...
             * @param udi the UDI of the volume
             */
            virtual void teardownDone(VHardware::ErrorType error, QVariant resultData, const QString &udi) = 0;
