...
#ifndef VHARDWARE_IFACES_STORAGEDRIVE_H
#define VHARDWARE_IFACES_STORAGEDRIVE_H
...
namespace VHardware
{
    namespace Ifaces
    {
         ...
         */
        class VIBE_EXPORT StorageDrive : virtual public Block
        {
        public:
            /**
             ...
             */
            virtual VStorageDrive::Bus bus() const = 0;
             ...
             */
            virtual VStorageDrive::DriveType driveType() const = 0;
