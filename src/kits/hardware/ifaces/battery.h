...
namespace QubeHardware
{
    namespace Ifaces
    {
        ...
        public:
             ...
             * @see QubeHardware::Battery::BatteryType
             */
            virtual QubeHardware::Battery::BatteryType type() const = 0;
             ...
             * @see QubeHardware::Battery::ChargeState
             */
            virtual QubeHardware::Battery::ChargeState chargeState() const = 0;
        ...
        protected:
             ...
             * the type QubeHardware::Battery::ChargeState
             * @see QubeHardware::Battery::ChargeState
...
Q_DECLARE_INTERFACE(QubeHardware::Ifaces::Battery, "org.vision.Hardware.Ifaces.Battery/0.1")
