...
namespace QubeHardware
{
    namespace Ifaces
    {
        ...
        public:
             ...
             * @see QubeHardware::StorageVolume::UsageType
             */
            virtual QubeHardware::StorageVolume::UsageType usage() const = 0;
...
Q_DECLARE_INTERFACE(QubeHardware::Ifaces::StorageVolume, "org.vision.Hardware.Ifaces.StorageVolume/0.1")
