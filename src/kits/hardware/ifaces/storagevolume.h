...
#ifndef VHARDWARE_IFACES_STORAGEVOLUME_H
#define VHARDWARE_IFACES_STORAGEVOLUME_H
...
namespace VHardware
{
    namespace Ifaces
    {
         ...
         */
        class VIBE_EXPORT StorageVolume : virtual public Block
        {
        public:
            /**
             ...
             */
            virtual VStorageVolume::UsageType usage() const = 0;
