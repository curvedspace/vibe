    ...
    namespace Hardware
    {
        namespace Ifaces
        {
            ...
            public:
                 ...
                 */
                virtual bool queryDeviceInterface(const Qube::Hardware::DeviceInterface::Type &type) const = 0;
                 ...
                 */
                virtual QObject *createDeviceInterface(const Qube::Hardware::DeviceInterface::Type &type) = 0;
                ...
                void broadcastActionDone(const QString &actionName,
                                         int error = Qube::Hardware::NoError,
