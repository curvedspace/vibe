...
namespace QubeHardware
{
    namespace Ifaces
    {
        ...
        public:
             ...
             */
            virtual bool queryDeviceInterface(const QubeHardware::DeviceInterface::Type &type) const = 0;
             ...
             */
            virtual QObject *createDeviceInterface(const QubeHardware::DeviceInterface::Type &type) = 0;
            ...
            void broadcastActionDone(const QString &actionName,
                                     int error = QubeHardware::NoError,
