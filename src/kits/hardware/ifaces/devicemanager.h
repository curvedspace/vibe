...
namespace QubeHardware
{
    namespace Ifaces
    {
        ...
        public:
             ...
             */
            virtual QSet<QubeHardware::DeviceInterface::Type> supportedInterfaces() const = 0;
            ...
            virtual QStringList devicesFromQuery(const QString &parentUdi,
                                                 QubeHardware::DeviceInterface::Type type = QubeHardware::DeviceInterface::Unknown) = 0;
