...
#ifndef QUBE_HARDWARE_IFACES_DEVICEMANAGER_H
#define QUBE_HARDWARE_IFACES_DEVICEMANAGER_H
    ...
    namespace Hardware
    {
        namespace Ifaces
        {
            ...
            public:
                 ...
                 */
                virtual QSet<Qube::Hardware::DeviceInterface::Type> supportedInterfaces() const = 0;
                ...
                virtual QStringList devicesFromQuery(const QString &parentUdi,
                                                     Qube::Hardware::DeviceInterface::Type type = Qube::Hardware::DeviceInterface::Unknown) = 0;
