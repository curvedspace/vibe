...
#ifndef VHARDWARE_IFACES_DEVICEMANAGER_H
#define VHARDWARE_IFACES_DEVICEMANAGER_H
...
namespace VHardware
{
    namespace Ifaces
    {
         ...
         */
        class VIBE_EXPORT DeviceManager : public QObject
        {
            Q_OBJECT
        public:
            /**
             ...
             */
            virtual QSet<VDeviceInterface::Type> supportedInterfaces() const = 0;
            ...
            virtual QStringList devicesFromQuery(const QString &parentUdi,
                                                 VDeviceInterface::Type type = VDeviceInterface::Unknown) = 0;
...
#endif // VHARDWARE_IFACES_DEVICEMANAGER_H
