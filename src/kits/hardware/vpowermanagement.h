...
#ifndef VPOWERMANAGEMENT_H
#define VPOWERMANAGEMENT_H
...
namespace VHardware
{
    ...
    namespace PowerManagement
    {
         ...
         * @see VPowerManager::SuspendMethod
         * @see VPowerManager::SuspendMethods
         */
        ...
        class VIBE_EXPORT Notifier : public QObject
        {
            Q_OBJECT
        Q_SIGNALS:
            /**
             ...
             * type @see VPowerManager::AcAdapterState
             */
