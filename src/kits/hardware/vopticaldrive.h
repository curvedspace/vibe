...
#ifndef VOPTICALDRIVE_H
#define VOPTICALDRIVE_H
 ...
 */
class VIBE_EXPORT VOpticalDrive : public VStorageDrive
{
    Q_OBJECT
    Q_ENUMS(MediumType)
    Q_FLAGS(MediumTypes)
    ...
    Q_DECLARE_PRIVATE(VOpticalDrive)
...
private:
    /**
     * Creates a new VOpticalDrive object.
     ...
     * @see VDevice::as()
     */
    explicit VOpticalDrive(QObject *backendObject);

public:
    /**
     * Destroys a VOpticalDrive object.
     */
    virtual ~VOpticalDrive();

    /**
     * Get the VDeviceInterface::Type of the OpticalDrive device interface.
     *
...
Q_DECLARE_OPERATORS_FOR_FLAGS(VOpticalDrive::MediumTypes)

#endif // VOPTICALDRIVE_H
