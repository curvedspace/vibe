...
#ifndef QUBE_HARDWARE_DEVICE_H
#define QUBE_HARDWARE_DEVICE_H
...
namespace Qube
{
    namespace Hardware
    {
        ...
        public:
             ...
             *
             * \warning Don't use the UDI for anything except communication with QubeHardware. Also don't store
