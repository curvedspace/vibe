...
namespace Qube
{
    namespace Hardware
    {
         ...
         */
        class StorageVolume : public DeviceInterface
        {
            Q_OBJECT
            Q_ENUMS(UsageType)
        ...
        public:
            ...
            /**
             * Get the Qube::Hardware::DeviceInterface::Type of the StorageVolume device interface.
             *
             ...
             * @see Qube::Hardware::StorageVolume::UsageType
             */
