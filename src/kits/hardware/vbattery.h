...
class VBatteryPrivate;
class VDevice;

/**
 * This device interface is available on batteries.
 */
class VIBE_EXPORT VBattery : public VDeviceInterface
{
    Q_OBJECT
...
private:
     ...
     * @see VDevice::as()
     */
    explicit VBattery(QObject *backendObject);

public:
    /**
     * Destroys a VBattery object.
     */
    virtual ~VBattery();

    /**
     * Get the VDeviceInterface::Type of the VBattery device interface.
     *
     * @return the VBattery device interface type
