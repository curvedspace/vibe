...
namespace QubeHardware
{
    namespace Backends
    {
        namespace KUPnP
        {
            ...
            void AbstractDeviceFactory::addSupportedInterfaces( QSet<QubeHardware::DeviceInterface::Type>& interfaces ) const
            {
                Q_UNUSED( interfaces );
            }
#if 0
            bool AbstractDeviceFactory::hasDeviceInterface( const Cagibi::Device& device,
                    QubeHardware::DeviceInterface::Type type ) const
            {
                Q_UNUSED( device );
                Q_UNUSED( type );
...
#endif
            QStringList AbstractDeviceFactory::typeNames( QubeHardware::DeviceInterface::Type type ) const
            {
                Q_UNUSED( type );
            ...
            bool KUPnPDevice::queryDeviceInterface(const QubeHardware::DeviceInterface::Type& type) const
            {
                Q_UNUSED( type );
            ...
            QObject* KUPnPDevice::createDeviceInterface(const QubeHardware::DeviceInterface::Type& type)
            {
                Q_UNUSED( type );
