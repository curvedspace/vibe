...
namespace VHardware
{
    namespace Backends
    {
        namespace KUPnP
        {
            ...
            void AbstractDeviceFactory::addSupportedInterfaces(QSet<VDeviceInterface::Type>& interfaces) const
            {
                Q_UNUSED(interfaces);
            }
#if 0
...
#endif
            QStringList AbstractDeviceFactory::typeNames(VDeviceInterface::Type type) const
            {
                Q_UNUSED(type);
            ...
            bool KUPnPDevice::queryDeviceInterface(const VDeviceInterface::Type &type) const
            {
                Q_UNUSED(type);
            ...
            QObject *KUPnPDevice::createDeviceInterface(const VDeviceInterface::Type &type)
            {
                Q_UNUSED(type);
