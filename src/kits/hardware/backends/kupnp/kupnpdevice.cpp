    ...
    namespace Hardware
    {
        namespace Backends
        {
            namespace KUPnP
            {
                ...
                void AbstractDeviceFactory::addSupportedInterfaces(QSet<Qube::Hardware::DeviceInterface::Type>& interfaces) const
                {
                    Q_UNUSED(interfaces);
                }
#if 0
                bool AbstractDeviceFactory::hasDeviceInterface(const Cagibi::Device& device,
                        Qube::Hardware::DeviceInterface::Type type) const
                {
                    Q_UNUSED(device);
                    Q_UNUSED(type);
...
#endif
                QStringList AbstractDeviceFactory::typeNames(Qube::Hardware::DeviceInterface::Type type) const
                {
                    Q_UNUSED(type);
                ...
                bool KUPnPDevice::queryDeviceInterface(const Qube::Hardware::DeviceInterface::Type& type) const
                {
                    Q_UNUSED(type);
                ...
                QObject* KUPnPDevice::createDeviceInterface(const Qube::Hardware::DeviceInterface::Type& type)
                {
                    Q_UNUSED(type);
