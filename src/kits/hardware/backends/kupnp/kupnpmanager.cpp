...
namespace VHardware
{
    namespace Backends
    {
        namespace KUPnP
        {
            ...
            QSet<VDeviceInterface::Type> KUPnPManager::supportedInterfaces() const
            {
                    ...
                    VDeviceInterface::Type type)
            {
                ...
                if (parentUdi.isEmpty()) {
                    if (type != VDeviceInterface::Unknown) {
                        result << mUdiPrefix;
                    }
                } else {
            ...
            QStringList KUPnPManager::findDeviceByDeviceInterface(VDeviceInterface::Type type)
            {
                QStringList result;
