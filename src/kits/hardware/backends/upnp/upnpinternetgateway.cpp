    ...
    namespace Hardware
    {
        namespace Backends
        {
            namespace UPnP
            {
                ...
                Qube::Hardware::InternetGateway::InternetStatus UPnPInternetGateway::isEnabledForInternet() const
                {
                    Herqq::Upnp::HClientDevices embeddedDevices = upnpDevice()->device()->embeddedDevices();
                    Herqq::Upnp::HClientDevice* wanDevice = getDevice(QString::fromLatin1("WANDevice"), embeddedDevices);
                    ...
                    if (wanDevice) {
                        ...
                        if (wanCommonIfaceConfigService) {
                            ...
                            if (enabledForInternetVariable) {
                                ...
                                return enabled ? Qube::Hardware::InternetGateway::InternetEnabled : Qube::Hardware::InternetGateway::InternetDisabled;
                            } else {
                                ...
                                return Qube::Hardware::InternetGateway::UnknownStatus;
                            }
                        } else {
                            qWarning() << "Unable to retrieve WANCommonInterfaceConfig service for this device:" << upnpDevice()->udi();
                            return Qube::Hardware::InternetGateway::UnknownStatus;
                ...
                void UPnPInternetGateway::deletePortMapping(const QString& remoteHost, qint16 externalPort, const Qube::Hardware::InternetGateway::NetworkProtocol& mappingProtocol)
                {
                    Herqq::Upnp::HClientDevices embeddedDevices = upnpDevice()->device()->embeddedDevices();
                    Herqq::Upnp::HClientDevice* wanDevice = getDevice(QString::fromLatin1("WANDevice"), embeddedDevices);
                    if (wanDevice) {
                        ...
                        if (wanConnectionService) {
                            ...
                            if (deletePortMappingAction) {
                                ...
                                if (mappingProtocol == Qube::Hardware::InternetGateway::TCP) {
                ...
                void UPnPInternetGateway::deletePortMappingInvokeCallback(Herqq::Upnp::HClientAction *action, const Herqq::Upnp::HClientActionOp &invocationID)
                {
                    ...
                    if (invocationID.returnValue() == Herqq::Upnp::UpnpSuccess) {
                        ...
                        Qube::Hardware::InternetGateway::NetworkProtocol protocol;
                        if (newProtocol == QString::fromLatin1("TCP")) {
                            protocol = Qube::Hardware::InternetGateway::TCP;
                        } else {
                            protocol = Qube::Hardware::InternetGateway::UDP;
                        }
                ...
                void UPnPInternetGateway::addPortMapping(const QString& remoteHost, qint16 externalPort, const Qube::Hardware::InternetGateway::NetworkProtocol& mappingProtocol,
