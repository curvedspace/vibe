...
namespace QubeHardware
{
    namespace Backends
    {
        namespace UPnP
        {
            ...
            QubeHardware::InternetGateway::InternetStatus UPnPInternetGateway::isEnabledForInternet() const
            {
                Herqq::Upnp::HClientDevices embeddedDevices = upnpDevice()->device()->embeddedDevices();
                Herqq::Upnp::HClientDevice* wanDevice = getDevice(QString::fromLatin1("WANDevice"), embeddedDevices);
                ...
                if (wanDevice) {
                    ...
                    if (wanCommonIfaceConfigService) {
                        ...
                        if (enabledForInternetVariable) {
                            ...
                            return enabled ? QubeHardware::InternetGateway::InternetEnabled : QubeHardware::InternetGateway::InternetDisabled;
                        } else {
                            ...
                            return QubeHardware::InternetGateway::UnknownStatus;
                        }
                    } else {
                        qWarning() << "Unable to retrieve WANCommonInterfaceConfig service for this device:" << upnpDevice()->udi();
                        return QubeHardware::InternetGateway::UnknownStatus;
            ...
            void UPnPInternetGateway::deletePortMapping(const QString& remoteHost, qint16 externalPort, const QubeHardware::InternetGateway::NetworkProtocol& mappingProtocol)
            {
                Herqq::Upnp::HClientDevices embeddedDevices = upnpDevice()->device()->embeddedDevices();
                Herqq::Upnp::HClientDevice* wanDevice = getDevice(QString::fromLatin1("WANDevice"), embeddedDevices);
                if (wanDevice) {
                    ...
                    if (wanConnectionService) {
                        ...
                        if (deletePortMappingAction) {
                            ...
                            if (mappingProtocol == QubeHardware::InternetGateway::TCP) {
            ...
            void UPnPInternetGateway::deletePortMappingInvokeCallback(Herqq::Upnp::HClientAction *action, const Herqq::Upnp::HClientActionOp &invocationID)
            {
                ...
                if (invocationID.returnValue() == Herqq::Upnp::UpnpSuccess) {
                    ...
                    QubeHardware::InternetGateway::NetworkProtocol protocol;
                    if (newProtocol == QString::fromLatin1("TCP")) {
                        protocol = QubeHardware::InternetGateway::TCP;
                    } else {
                        protocol = QubeHardware::InternetGateway::UDP;
                    }
            ...
            void UPnPInternetGateway::addPortMapping(const QString& remoteHost, qint16 externalPort, const QubeHardware::InternetGateway::NetworkProtocol& mappingProtocol,
