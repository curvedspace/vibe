...
#ifndef QUBE_HARDWARE_BACKENDS_UPNP_UPNPINTERNETGATEWAY_H
#define QUBE_HARDWARE_BACKENDS_UPNP_UPNPINTERNETGATEWAY_H
...
#endif // QUBE_HARDWARE_BACKENDS_UPNP_UPNPINTERNETGATEWAY_H
