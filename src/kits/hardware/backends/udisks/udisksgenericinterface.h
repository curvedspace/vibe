...
#ifndef VHARDWARE_BACKENDS_UDISKS_GENERICINTERFACE_H
#define VHARDWARE_BACKENDS_UDISKS_GENERICINTERFACE_H
...
#endif // VHARDWARE_BACKENDS_UDISKS_GENERICINTERFACE_H
