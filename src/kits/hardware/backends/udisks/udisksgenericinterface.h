...
#ifndef QUBE_HARDWARE_BACKENDS_UDISKS_GENERICINTERFACE_H
#define QUBE_HARDWARE_BACKENDS_UDISKS_GENERICINTERFACE_H
...
#endif // QUBE_HARDWARE_BACKENDS_UDISKS_GENERICINTERFACE_H
