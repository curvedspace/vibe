...
#ifndef QUBE_HARDWARE_CAMERA_H
#define QUBE_HARDWARE_CAMERA_H
...
namespace Qube
{
    namespace Hardware
    {
         ...
         */
        class Camera : public DeviceInterface
        {
            Q_OBJECT
        ...
        public:
            ...
            /**
             * Get the Qube::Hardware::DeviceInterface::Type of the Camera device interface.
             *
