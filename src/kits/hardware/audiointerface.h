...
namespace QubeHardware
{
     ...
     */
    class QUBESHARED_EXPORT AudioInterface : public DeviceInterface
    {
        Q_OBJECT
    ...
    public:
        ...
        /**
         * Get the QubeHardware::DeviceInterface::Type of the AudioInterface device interface.
         *
         * @return the AudioInterface device interface type
         * @see QubeHardware::DeviceInterface::Type
         */
        static Type deviceInterfaceType() {
            return DeviceInterface::AudioInterface;
        }
         ...
         * @see QubeHardware::AudioInterface::AudioInterfaceType
         */
...
Q_DECLARE_OPERATORS_FOR_FLAGS(QubeHardware::AudioInterface::AudioInterfaceTypes)
