...
namespace Qube
{
    namespace Hardware
    {
         ...
         */
        class AudioInterface : public DeviceInterface
        {
            Q_OBJECT
        ...
        public:
            ...
            /**
             * Get the Qube::Hardware::DeviceInterface::Type of the AudioInterface device interface.
             *
             ...
             * @see Qube::Hardware::AudioInterface::AudioInterfaceType
             */
