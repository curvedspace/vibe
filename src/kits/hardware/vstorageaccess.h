...
#ifndef VSTORAGEACCESS_H
#define VSTORAGEACCESS_H
 ...
 */
class VIBE_EXPORT VStorageAccess : public VDeviceInterface
{
    Q_OBJECT
    Q_PROPERTY(bool accessible READ isAccessible)
    Q_PROPERTY(QString filePath READ filePath)
    Q_PROPERTY(bool ignored READ isIgnored)
    Q_DECLARE_PRIVATE(VStorageAccess)
    friend class VDevice;

private:
    /**
     * Creates a new VStorageAccess object.
     ...
     * @see VDevice::as()
     */
    explicit VStorageAccess(QObject *backendObject);

public:
    /**
     * Destroys a VStorageAccess object.
     */
    virtual ~VStorageAccess();

    /**
     * Get the VDeviceInterface::Type of the StorageAccess device interface.
     *
     * @return the StorageVolume device interface type
     * @see VHardware::Ifaces::Enums::DeviceInterface::Type
     */
    static Type deviceInterfaceType() {
        return VDeviceInterface::StorageAccess;
    }
...
protected:
     ...
     * @internal
     */
    VStorageAccess(VStorageAccessPrivate &dd, QObject *backendObject);
};

#endif // VSTORAGEACCESS_H
