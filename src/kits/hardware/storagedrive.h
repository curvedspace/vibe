...
#ifndef QUBE_HARDWARE_STORAGEDRIVE_H
#define QUBE_HARDWARE_STORAGEDRIVE_H
...
namespace Qube
{
    namespace Hardware
    {
         ...
         */
        class StorageDrive : public DeviceInterface
        {
            Q_OBJECT
        ...
        public:
            ...
            /**
             * Get the Qube::Hardware::DeviceInterface::Type of the StorageDrive device interface.
             *
...
#endif // QUBE_HARDWARE_STORAGEDRIVE_H
