...
namespace QubeHardware
{
     ...
     */
    class QUBESHARED_EXPORT PortableMediaPlayer : public DeviceInterface
    {
        Q_OBJECT
    ...
    public:
        ...
        /**
         * Get the QubeHardware::DeviceInterface::Type of the PortableMediaPlayer device interface.
         *
