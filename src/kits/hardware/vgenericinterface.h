...
#ifndef VGENERICINTERFACE_H
#define VGENERICINTERFACE_H
...
class VGenericInterfacePrivate;
class VDevice;
 ...
 */
class VIBE_EXPORT VGenericInterface : public VDeviceInterface
{
    Q_OBJECT
    Q_ENUMS(PropertyChange)
    Q_DECLARE_PRIVATE(VGenericInterface)
...
private:
    /**
     * Creates a new VGenericInterface object.
     ...
     * @see VDevice::as()
     */
    explicit VGenericInterface(QObject *backendObject);

public:
    /**
     * Destroys a VGenericInterface object.
     */
    virtual ~VGenericInterface();

    /**
     * Get the VDeviceInterface::Type of the GenericInterface device interface.
     *
...
Q_SIGNALS:
     ...
     * (added/removed/modified), it's one of the type VDevice::PropertyChange
     */
