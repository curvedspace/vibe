...
#ifndef VDEVICENOTIFIER_H
#define VDEVICENOTIFIER_H
 ...
 */
class VIBE_EXPORT VDeviceNotifier : public QObject //krazy:exclude=dpointer (interface class)
{
    Q_OBJECT
public:
    static VDeviceNotifier *instance();
