...
#ifndef VOPTICALDISC_H
#define VOPTICALDISC_H

#include <VibeCore/VGlobal>
#include <VibeHardware/VStorageVolume>

class VOpticalDiscPrivate;
class VDevice;
 ...
 */
class VIBE_EXPORT VOpticalDisc : public VStorageVolume
{
    Q_OBJECT
    ...
    Q_DECLARE_PRIVATE(VOpticalDisc)
...
private:
    /**
     * Creates a new VOpticalDisc object.
     ...
     * @see VDevice::as()
     */
    explicit VOpticalDisc(QObject *backendObject);

public:
    /**
     * Destroys a VOpticalDisc object.
     */
    virtual ~VOpticalDisc();

    /**
     * Get the VDeviceInterface::Type of the OpticalDisc device interface.
     *
...
Q_DECLARE_OPERATORS_FOR_FLAGS(VOpticalDisc::ContentTypes)

#endif // VOPTICALDISC_H
