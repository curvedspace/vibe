...
namespace QubeHardware
{
     ...
     */
    class QUBESHARED_EXPORT Button : public DeviceInterface
    {
        Q_OBJECT
        Q_ENUMS(ButtonType)
    ...
    public:
        ...
        /**
         * Get the QubeHardware::DeviceInterface::Type of the Button device interface.
         *
    ...
    Q_SIGNALS:
         ...
         */
        void pressed(QubeHardware::Button::ButtonType type, const QString &udi);
    };
}
