...
namespace QubeHardware
{
    ...
    namespace Networking
    {
        ...
        Q_SIGNALS:
             ...
             */
            void statusChanged( QubeHardware::Networking::Status status );
            /**
