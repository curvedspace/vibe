...
#ifndef QUBE_HARDWARE_OPTICALDISC_H
#define QUBE_HARDWARE_OPTICALDISC_H
...
namespace Qube
{
    namespace Hardware
    {
        ...
        public:
            ...
            /**
             * Get the Qube::Hardware::DeviceInterface::Type of the OpticalDisc device interface.
             *
             ...
             * @see Qube::Hardware::OpticalDisc::ContentType
             */
...
Q_DECLARE_OPERATORS_FOR_FLAGS(Qube::Hardware::OpticalDisc::ContentTypes)
