...
namespace QubeHardware
{
     ...
     */
    class QUBESHARED_EXPORT OpticalDisc : public StorageVolume
    {
        Q_OBJECT
    ...
    public:
        ...
        /**
         * Get the QubeHardware::DeviceInterface::Type of the OpticalDisc device interface.
         *
         ...
         * @see QubeHardware::OpticalDisc::ContentType
         */
...
Q_DECLARE_OPERATORS_FOR_FLAGS(QubeHardware::OpticalDisc::ContentTypes)
