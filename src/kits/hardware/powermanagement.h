...
namespace QubeHardware
{
    ...
    namespace PowerManagement
    {
         ...
         */
        QUBESHARED_EXPORT bool appShouldConserveResources();
         ...
         * @see QubeHardware::PowerManager::SuspendMethod
         * @see QubeHardware::PowerManager::SuspendMethods
         */
        QUBESHARED_EXPORT QSet<SleepState> supportedSleepStates();
         ...
         */
        QUBESHARED_EXPORT void requestSleep(SleepState state, QObject *receiver, const char *member);
         ...
         * denied.
         */
        QUBESHARED_EXPORT int beginSuppressingSleep(const QString &reason = QString());
         ...
         */
        QUBESHARED_EXPORT bool stopSuppressingSleep(int cookie);
         ...
         * @since 4.6
         */
        QUBESHARED_EXPORT int beginSuppressingScreenPowerManagement(const QString &reason = QString());
         ...
         * @since 4.6
         */
        QUBESHARED_EXPORT bool stopSuppressingScreenPowerManagement(int cookie);

        class QUBESHARED_EXPORT Notifier : public QObject
        {
            Q_OBJECT
        Q_SIGNALS:
            /**
             ...
             * type @see QubeHardware::PowerManager::AcAdapterState
             */
        ...
        QUBESHARED_EXPORT Notifier *notifier();
    }
}
