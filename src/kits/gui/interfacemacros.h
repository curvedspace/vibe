...
#ifndef QUBE_INTERFACEMACROS_H
#define QUBE_INTERFACEMACROS_H

#define QUBE_DECLARE_UI(Class) \
...
#define QUBE_UI(Class) Class##Ui *ui = ui_func()
#define QUBE_WIDGET(Class) Class *w = w_func()
#define QUBE_WIDGET_CAST inline QWidget *toWidget() { return this; } \
	inline const QWidget * toWidget() const { return this; }

#endif // QUBE_INTERFACEMACROS_H
