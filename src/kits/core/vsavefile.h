 ...
 *
 * The VSaveFile class has been made to write out changes to an existing
 ...
 * to be corrupt.
 *
 * When you create a VSaveFile for a given file, a temporary file is instead
 ...
 * the target file is untouched. VSaveFile derives from QFile so you can use
 ...
 *
 * Here is a quick example of how to use VSaveFile:
 *
 * First we create the VSaveFile and open it.
 *
 * @code
 * VSaveFile saveFile;
