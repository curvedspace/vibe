...
#ifndef QUBE_SAVEFILE_H
#define QUBE_SAVEFILE_H
...
namespace Qube
{
    ...
    {
        /**
         * \class SaveFile savefile.h <SaveFile>
         *
         * @brief Class to allow for atomic file I/O, as well as utility functions.
         *
         * The SaveFile class has been made to write out changes to an existing
         ...
         * to be corrupt.
         *
         * When you create a SaveFile for a given file, a temporary file is instead
         ...
         * the target file is untouched. SaveFile derives from QFile so you can use
         ...
         *
         * Here is a quick example of how to use SaveFile:
         *
         * First we create the SaveFile and open it.
         *
         * @code
         * SaveFile saveFile;
        ...
        public:
            ...
            /**
             * Creates a new SaveFile and sets the target file to @p filename.
             *
             ...
             * You can use this method even if you don't use SaveFile.
