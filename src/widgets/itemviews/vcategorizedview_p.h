...
#ifndef VCATEGORIZEDVIEW_P_H
#define VCATEGORIZEDVIEW_P_H
...
/**
  * @internal
  */
class VCategorizedView::Private
{
public:
    struct Block;
    struct Item;

    Private(VCategorizedView *q);
    ~Private();
    ...
    VCategorizedView *q;
    VCategorizedSortFilterProxyModel *proxyModel;
    VCategoryDrawer *categoryDrawer;
    int categorySpacing;
